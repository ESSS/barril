...
# image downloaded from https://www.freeiconspng.com/img/20876
html_logo = "img/barrel-png-26.png"
...
latex_documents = [
    (master_doc, "barril.tex", "Barril Documentation", "ESSS", "manual")
]
